<form action="action_page.php">
  <div class="container">
    ...
    <input type="text" placeholder="Enter the First Name" name="Name" id="Name" required>
    <br>
    ...
    <input type="password" placeholder="Repeat the Password here" name="psw-repeat" id="psw-repeat" required>
    <hr>
    <br>
